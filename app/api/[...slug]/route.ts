import { type RequestHooks, serverSlideAPI } from "@/server/route";
...
export async function GET(
	...
	const slug = slugParam[0] as keyof typeof serverSlideAPI;
	...
	if (serverSlideAPI[slug]) {
		try {
			const result = await (serverSlideAPI[slug] as any)(
				...query,
				requestHooks
			);
