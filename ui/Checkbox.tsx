...
export default function Checkbox(props: React.PropsWithChildren<UIProps<{ checked?: boolean }>>) {
  return (
    <span className="flex items-center">
      ...
      >
        {props.checked && (
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" className="stroke-color-bg">
            <path
              stroke="inherit"
              strokeLinecap="round"
              strokeWidth="2"
